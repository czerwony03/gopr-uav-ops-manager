...
export default function EditProcedureScreen() {
  ...
  useEffect(() => {
    ...
    // Only managers and admins can edit procedures
  ...
  }, [id, user, router, loadChecklistData, t]);
      ...
      >
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.content}>
            <Text style={styles.title}>{t('procedureForm.editTitle')}</Text>
          ...
          >
            {loading ? (
              ...
              <>
                ...
                <Text style={styles.submitButtonText}>{t('procedureForm.update')}</Text>
              </>
            )}
          </TouchableOpacity>
        </View>
